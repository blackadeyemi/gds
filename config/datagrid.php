...
return [
    'grids' => [
        ...
        \Modules\Core\Livewire\Admin\Warehouses::class,
        \Modules\Core\Livewire\Admin\WarehouseEntrances::class,
        \Modules\Core\Livewire\Admin\FactoryExitLocations::class,
