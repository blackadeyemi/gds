<div>
    <div class="page-head">
        ...
        <p>Move raw-material stock between stores — scan items at the exit store and send them to the destination.</p>
    </div>
    ...
    <div class="card card-pad">
        <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(180px,1fr));gap:0.75rem;">
            ...
            <div class="form-group">
                ...
                <select class="form-control" wire:model.live="exitLocation">
                    <option value="">Select exit location</option>
                    @foreach ($this->exitLocations as $loc)
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" value="{{ $this->transferLocation() ?: '—' }}" disabled>
            </div>
            <div class="form-group">
        ...
        <form wire:submit.prevent="addScan" style="margin-top:0.5rem;">
            <div class="form-group" style="max-width:520px;">
                ...
                <input type="text" class="form-control" wire:model="scan" wire:key="scan-input"
                       placeholder="{{ $exitLocation === '' ? 'Select an exit location first' : 'Scan or type a barcode, then Enter' }}"
                       autocomplete="off" @disabled($exitLocation === '') autofocus>
                @if ($scanError)
        ...
        <div style="margin-top:1.25rem;max-width:520px;">
            <button type="button" class="btn btn-primary" style="width:100%;"
                ...
                <span wire:loading.remove wire:target="save">Transfer ({{ count($items) }})</span>
