<div class="form-group">
    ...
    <div class="text-muted text-sm" style="margin-top:.25rem;">
        Goods moving through this gate change this warehouse's stock.
...
<div class="form-group">
    ...
    <input type="text" class="form-control" wire:model="name" placeholder="e.g. Ogba Gate 1" autofocus>
...
<div class="form-group">
    ...
    <div class="text-muted text-sm" style="margin-top:.25rem;">
        Which way goods move. Pick <strong>Entrance &amp; Exit</strong> for a gate used both ways —
        it will then appear on both the receiving and the issuing screen.
    </div>
